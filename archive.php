...
<?php 
    $query = "SELECT * FROM tblresident WHERE archive =1 ";
...
<head>
	...
	<title>Archive -  Barangay Management System</title>
</head>
<body>
				...
				<div class="panel-header" style="background: linear-gradient(45deg,#cbbeb5,#3a3500);">
					<div class="page-inner">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								<h2 class="text-white fw-bold" style="font-style: Century-gothic; color:white ;  text-shadow: 2px 2px 5px #354259;">ARCHIVE</h2>
							</div>
						</div>
					</div>
				</div>
